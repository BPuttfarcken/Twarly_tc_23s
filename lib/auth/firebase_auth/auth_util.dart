...
DocumentReference? get currentUserReference =>
    loggedIn ? TicketListeRecord.collection.doc(currentUser!.uid) : null;

TicketListeRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : TicketListeRecord.getDocument(TicketListeRecord.collection.doc(uid))
              .handleError((_) {}),
    )
