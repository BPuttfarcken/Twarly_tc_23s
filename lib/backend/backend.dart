...
import 'schema/test_liste_record.dart';
...
export 'schema/test_liste_record.dart';
...
Stream<List<TestListeRecord>> queryTestListeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
...
Future<List<TestListeRecord>> queryTestListeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryTicketListeRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<TicketListeRecord>> queryTicketListeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<TicketListeRecord>> queryTicketListeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Stream<List<WasteCounterRecord>> queryWasteCounterRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<WasteCounterRecord>> queryWasteCounterRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryBilderRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<BilderRecord>> queryBilderRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<BilderRecord>> queryBilderRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future maybeCreateUser(User user) async {
  final userRecord = TicketListeRecord.collection.doc(user.uid);
  final userExists = await userRecord.get().then((u) => u.exists);
  if (userExists) {
    currentUserDocument = await TicketListeRecord.getDocumentOnce(userRecord);
    return;
  }

  final userData = createTicketListeRecordData(
    email: user.email,
